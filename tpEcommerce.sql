...
INSERT INTO `maillot` (`equipe`, `domExt`, `couleurPrincipal`, `marque`, `prix`, `quantite`, `taille`, `nomFichier`) VALUES
    ...
    ('France', 'dom', 'bleu', 'nike', 89.99, 1, 'M', 'maillot-equipe-de-france-coupe-du-monde-2022-1024x1024.jpg'),
    ('France', 'ext', 'blanc', 'nike', 89.99, 1, 'M', 'maillot-equipe-de-france-coupe-du-monde-2022-nike-1024x868.jpg'),
    ...
    ('Pays de Galles', 'dom', 'rouge', 'adidas', 80, 1, 'M', 'maillot-pays-de-galles-coupe-du-monde-2022-1024x1024.jpg'),
    ...
    ('Pologne', 'ext', 'rouge', 'nike', 89.99, 1, 'M', 'maillot-pologne-2022.jpg'),
    ('Portugal', 'dom', 'rouge', 'nike', 89.99, 1, 'M', 'maillot-portugal-coupe-du-monde-2022.jpg'),
    ...
    ('Argentine', 'ext', 'bleu', 'adidas', 90, 1, 'M', 'maillot_argentine_coupe_du_monde_2022_adidas_exterieur.jpg'),
    ...
    ('Uruguay', 'ext', 'blanc', 'puma', 85, 1, 'M', 'maillot-uruguay-coupe-du-monde-2022-1024x1024.jpg'),
    ...
    ('Corée du Sud', 'dom', 'rouge', 'nike', 89.99, 1, 'M', 'maillot-coree-du-sud-coupe-du-monde-nike.jpg'),
    ...
    ('Japon', 'dom', 'bleu', 'adidas', 90, 1, 'M', 'maillot_japon_coupe_du_monde_2022_adidas_domicile.jpg'),
    ...
    ('Canada', 'dom', 'rouge', 'nike', 89.99, 1, 'M', 'maillot-canada-coupe-du-monde-2022-domicile-nike.jpg'),
    ('Canada', 'ext', 'blanc', 'nike', 89.99, 1, 'M', 'maillot-canada-coupe-du-monde-2022-exterieur-nike.jpg'),
    ('Costa Rica', 'dom', 'rouge', 'new balance', 80, 1, 'M', 'maillot-costa-rica-coupe-du-monde-2022.jpg'),
    ('Costa Rica', 'ext', 'blanc', 'new balance', 80, 1, 'M', 'maillot-costa-rica-coupe-du-monde-2022-new-balance.jpg'),
    ...
    ('Maroc', 'dom', 'rouge', 'puma', 85, 1, 'M', 'maillot-maroc-2022-coupe-du-monde.jpg'),
    ('Maroc', 'ext', 'blanc', 'puma', 85, 1, 'M', 'maillot-maroc-2022-coupe-du-monde-exterieur.jpg'),
